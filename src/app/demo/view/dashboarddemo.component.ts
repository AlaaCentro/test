...
import { AppBreadcrumbService } from 'src/app/Shared/services/app.breadcrumb.service';
import { AppConfig } from '../domain/appconfig';
import { ConfigService } from '../service/app.config.service';
import { Subscription } from 'rxjs';
import { AppMainComponent } from 'src/app/Shared/components/app.main.component';
...
export class DashboardDemoComponent implements OnInit {
    ...
    constructor(private breadcrumbService: AppBreadcrumbService,
        private appMain: AppMainComponent, public configService: ConfigService) {
